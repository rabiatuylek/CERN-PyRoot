...
h1 = ROOT.TH1F('h1','histogram 1; x axis; y axis', 100, -3, 3)
h2 = ROOT.TH1F('h2','histogram ; x axis; yaxis',100,-3,3)
...
h2.GetXaxis().SetTitle("x axis for h1 & h2")
h2.GetYaxis().SetTitle("y axis for h1 & h2")
